...
for user_address in accounts_list[separator: -1]:
    evchargingmarket.functions.registerNewUser(user_address).transact()
...
def handle_event(event):
	...
	if evchargingmarket.functions.contracts(auc_id).call()[10] == 4:
		...
		print("Selling Price: ", (seller_price ** 2) * 25)
		print("Buyer Price: ", buyer_price)
		print("Auctioner price: ", (seller_price ** 2) * 25 - buyer_price)
		...
		print("\nAuctioner @ Address", auctioner)
		print("Buyer balance: ", evchargingmarket.functions.accounts(auctioner).call()[0])
		print("Buyer charge: ", evchargingmarket.functions.accounts(auctioner).call()[1])
