...
print("Adding Auctioner to with initial balance of 1000000.")
auctioner_address = "0x877f503365C0b55F4259208D4327daF6BDC66d01"
auctioner_pvtkey = "876545b242014e371ab56e55f5553d5efda45b73df4280c7bc13754224fead9a"
nonce = w3.eth.getTransactionCount(auctioner_address)
tr = {
    'from': auctioner_address,
    'nonce': Web3.toHex(nonce),
    'gasPrice': Web3.toHex(gas_price)
}
print("Sending Transaction")
txn = evchargingmarket.functions.setAuctioner().buildTransaction(tr)
signed = w3.eth.account.sign_transaction(txn, auctioner_pvtkey)
tx_hash = w3.eth.send_raw_transaction(signed.rawTransaction)
tx_receipt = w3.eth.wait_for_transaction_receipt(tx_hash)

print(f"[SUCCESS] Auctioner Added with address 0x...{auctioner_address[-4:]}")