...
def payment_success(auc_id, buyer, seller, second_highest_price, second_lowest_price, energy):
	print(f"""
	\n[ID: {auc_id}][SUCCESS] Payment Success:
	\r\tSecond Lowest Price: {second_lowest_price}\n\tSecond Highest Price: {second_highest_price}
	\r\tEnergy Requested: {energy}\n\tPayment: {second_highest_price * energy}
	\nBuyer Details:
	\r\tAddress: {buyer}
...
def payment_failure(auc_id, buyer, seller, second_highest_price, second_lowest_price, energy):
	print(f"""
    ...
    while True:
        for pay_success in event_filter.get_new_entries():
        	thread = threading.Thread(target = payment_success, args = (
        		...
        		pay_success['args']['sechighprice'],
        		pay_success['args']['seclowprice'],
    ...
    while True:
        for pay_fail in event_filter.get_new_entries():
        	thread = threading.Thread(target = payment_failure, args = (
        		...
        		pay_fail['args']['sechighprice'],
        		pay_fail['args']['seclowprice'],
